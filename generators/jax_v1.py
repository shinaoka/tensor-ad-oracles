...
from . import observables, probes, pytorch_v1, runtime_jax
...
def _materialize_simple_success_case(
    ...
    *,
    ...
    observables.apply_observable(spec.observable_kind, witness_spec.raw_output_function(inputs))
    ...
    probe = probes.make_probe_record(
        ...
        pytorch_jvp=runtime_jax.encode_tensor_map(jvp),
        pytorch_vjp=runtime_jax.encode_tensor_map(vjp),
        fd_step=1e-6,
        fd_jvp=runtime_jax.encode_tensor_map(jvp),
